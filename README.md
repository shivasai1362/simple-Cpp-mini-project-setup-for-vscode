This is a simple python program to setup a mini c++ project(for practice) using vscode. You can include external libraries headers through the program for the project in VSCode.
